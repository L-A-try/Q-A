...
public class GridContainer {
	...
	/**
	 * Method to register a best-network-route Map for a given source Site 一种为给定源站点注册最佳网络路由图的方法
...
FileTransfer
    ...
    public DataFile replicate(DataFile fromFile, StorageElement toSE) {
		System.out.println("GridContainer replicate-----------");
	    ...
	    // unpin original file 锁住就是不让修改了吧--改成 比较时间戳
	     fromFile.releasePin();
